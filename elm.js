...
var _user$project$Main$mockText = '負けて１番悔い無しの王者相手に';
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			default:
				var _p1 = model.savedWords;
				if (_p1.ctor === '[]') {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					var _p3 = _p1._1;
					var _p2 = _p1._0;
					var score = _p0._0 ? (_p2.score + 3) : 1;
					var savedWords = A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_elm_lang$core$List$take, score, _p3),
						A2(
							_elm_lang$core$Basics_ops['++'],
							{
								ctor: '::',
							...
							A2(_elm_lang$core$List$drop, score, _p3)));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{savedWords: savedWords, backShown: false}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
		}
	});
var _user$project$Main$viewProfile = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('jumbotron mb-0'),
			_1: {
				ctor: '::',
			...
			_1: {
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('You\'ve learned 6 words today'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('progress my-4'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('6 / 10'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Your daily goal is 10 new words'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('btn btn-primary btn-block my-4'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Main$viewSaved = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(savedWord.word.kanji),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(savedWord.word.kana),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(savedWord.word.definition),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
...
var _user$project$Main$isBetween = F3(
	function (low, high, value) {
		return (_elm_lang$core$Native_Utils.cmp(low, value) < 1) && (_elm_lang$core$Native_Utils.cmp(value, high) < 1);
	});
var _user$project$Main$lookupEntry = F3(
	function (dict, index, text) {
		lookupEntry:
		while (true) {
			if (A3(
				_user$project$Main$isBetween,
				0,
				_elm_lang$core$String$length(text) - 1,
				index)) {
				var _p4 = A2(
					_elm_lang$core$Dict$get,
					A2(_elm_lang$core$String$dropLeft, index, text),
					dict);
				if (_p4.ctor === 'Nothing') {
					var _v3 = dict,
						_v4 = index,
						_v5 = A2(_elm_lang$core$String$dropRight, 1, text);
					dict = _v3;
					index = _v4;
					text = _v5;
					continue lookupEntry;
				} else {
					return {
						ctor: '_Tuple2',
						_0: _p4._0,
						_1: _elm_lang$core$String$length(text) - index
					};
				}
			} else {
...
_user$project$Main_ops['?:'] = F2(
	function (condition, _p6) {
		var _p7 = _p6;
		return condition ? _p7._0 : _p7._1;
	});
var _user$project$Main$characterColor = function (isSelected) {
	return A2(
		_user$project$Main_ops['?:'],
		isSelected,
		{ctor: '_Tuple2', _0: 'bg-primary text-white', _1: ''});
};
var _user$project$Main$routeColor = function (isCurrentRoute) {
	return A2(
		_user$project$Main_ops['?:'],
		isCurrentRoute,
		{ctor: '_Tuple2', _0: 'bg-primary text-white', _1: 'text-primary'});
};
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {input: a, selectedIndex: b, dict: c, savedWords: d, backShown: e, route: f};
	});
var _user$project$Main$SavedWord = F2(
	function (a, b) {
		return {word: a, score: b};
	});
var _user$project$Main$Word = F3(
	function (a, b, c) {
		return {kanji: a, kana: b, definition: c};
	});
var _user$project$Main$mockSavedWords = {
	ctor: '::',
	_0: A2(
		_user$project$Main$SavedWord,
		A3(_user$project$Main$Word, '負ける', 'まける', '(v1,vi) to lose; to be defeated; (P)'),
		1),
	_1: {
		ctor: '::',
		_0: A2(
			_user$project$Main$SavedWord,
			A3(_user$project$Main$Word, '番', 'ばん', '(n) number (in a series); (one\'s) turn; watch; guard; lookout; bout, match (sumo)'),
			1),
		_1: {
			ctor: '::',
			_0: A2(
				_user$project$Main$SavedWord,
				A3(_user$project$Main$Word, '悔い', 'くい', '(n) regret; repentance; (P)'),
				1),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Main$SavedWord,
					A3(_user$project$Main$Word, '無し', 'なし', '(n,n-suf,uk) without; (P)'),
					1),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$Main$SavedWord,
						A3(_user$project$Main$Word, '王者', 'おうじゃ', '(n) king; monarch; ruler; (P)'),
						1),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Main$SavedWord,
							A3(_user$project$Main$Word, '相手', 'あいて', '(n) companion; partner; company; other party; addressee; opponent (sports, etc.); (P)'),
							1),
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Main$ShowBack = {ctor: 'ShowBack'};
var _user$project$Main$viewStudy = function (model) {
	var first = A2(
		_elm_lang$core$Maybe$withDefault,
		A2(
			_user$project$Main$SavedWord,
			A3(_user$project$Main$Word, '', '', ''),
			1),
		_elm_lang$core$List$head(model.savedWords));
	return model.backShown ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(first.word.kanji),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(first.word.kana),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(first.word.definition),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
										...
										_elm_lang$html$Html$div,
										{
											...
											_1: {
												...
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Main$StudyRep(false)),
												_1: {ctor: '[]'}
											}
										},
										{
										...
										_0: A2(
											_elm_lang$html$Html$div,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Main$StudyRep(true)),
													_1: {ctor: '[]'}
												}
											},
											{
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ShowBack),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _user$project$Main$GoToRoute = function (a) {
	return {ctor: 'GoToRoute', _0: a};
};
var _user$project$Main$viewRoute = F3(
	function (currentRoute, route, routeText) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('col-3 px-0'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Main$GoToRoute(route)),
							_1: {ctor: '[]'}
						}
					},
					{
							...
							_elm_lang$html$Html$div,
							{
								...
								_0: _elm_lang$html$Html_Attributes$class(
									A2(
										...
										_user$project$Main$routeColor(
											_elm_lang$core$Native_Utils.eq(currentRoute, route)))),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(routeText),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _user$project$Main$viewRoutes = function (route) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A3(_user$project$Main$viewRoute, route, _user$project$Main$Read, 'Read'),
					_1: {
						ctor: '::',
						_0: A3(_user$project$Main$viewRoute, route, _user$project$Main$Study, 'Study'),
						_1: {
							ctor: '::',
							_0: A3(_user$project$Main$viewRoute, route, _user$project$Main$Saved, 'Saved'),
							_1: {
								ctor: '::',
								_0: A3(_user$project$Main$viewRoute, route, _user$project$Main$Profile, 'Profile'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Main$viewCharacter = F4(
	function (selectedIndex, entryLength, index, character) {
		return A2(
			_elm_lang$html$Html$h3,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Main$Select(index)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'd-inline-block ',
							_user$project$Main$characterColor(
								A3(_user$project$Main$isBetween, selectedIndex, (selectedIndex + entryLength) - 1, index)))),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Main$viewRead = function (model) {
	var _p8 = A3(_user$project$Main$lookupEntry, model.dict, model.selectedIndex, model.input);
	var entry = _p8._0;
	var entryLength = _p8._1;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				A2(
					_elm_lang$core$List$indexedMap,
					A2(_user$project$Main$viewCharacter, model.selectedIndex, entryLength),
					A2(_elm_lang$core$String$split, '', model.input))),
			_1: {
				ctor: '::',
				_0: _user$project$Main$viewEntry(entry),
				_1: {ctor: '[]'}
			}
		});
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('col-12 col-sm-8 offset-sm-2'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
				...
				},
				{
					...
					_0: function () {
						...
						switch (_p9.ctor) {
							case 'Read':
								return _user$project$Main$viewRead(model);
							case 'Study':
								return _user$project$Main$viewStudy(model);
							case 'Saved':
								return _user$project$Main$viewSaved(model);
							default:
					...
					_1: {
						ctor: '::',
						_0: _user$project$Main$viewRoutes(model.route),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
